...
class KITTIData(Dataset):
    ...
    def __preprocPcd__(self, pcdPath, calibCam2CamPath, calibVelo2CamPath):
        ...
        transformed_points = np.array(random.choices(transformed_points, cum_weights=None, weights=np.ones(shape=(transformed_points.shape[0], 1)), k=62464))
        transformed_points = transformed_points.T
    ...
    def __getitem__(self, idx):
        ...
        return {'Image': img, 'Depth': depth, 'Transform': randTrans, 
                'intrinsics': K}
